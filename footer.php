    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2 col-6">
                ...
                <a href="https://www.instagram.com/em.arsii/"><i class="fab fa-instagram"></i></a>
                <a href="https://twitter.com/rjarslan123"><i class="fab fa-twitter"></i></a>
            ...
            <div class="col-lg-4 col-12">
                ...
                <p class="copyr" style="color: white; margin-top: 20px"> &copy; <?php echo date("Y");?> By Arslan Nawaz. Dont steel my shit</p>
